...
export default function ActivityForm() {
  ...
  return (
    <div className="min-h-screen bg-background p-6 w-full">
      ...
      <div className=" mx-auto space-y-6 w-[90%]">
        <h1 className="text-3xl font-semibold text-center text-gray-800 dark:text-white mb-10">Detalles de la actividad</h1>

        <div className=" grid grid-cols-[repeat(3,1fr)] gap-4 w-full" >
          <div className="shadow-md rounded-lg p-6 text-black text-base space-y-6 bg-white dark:bg-gray-800 dark:text-white">
          ...
          {questions.map((question) => {
            switch (question.type) {
              case "text":
                return (
                  <div key={question.id} className="shadow-md rounded-lg p-6 text-black text-base space-y-6 bg-white dark:bg-gray-800 dark:text-white">
